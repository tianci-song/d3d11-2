...
wrl::ComPtr<ID3D12Resource> d3dUtil::CreateDefaultBuffer(
    ID3D12Device* device, 
...
wrl::ComPtr<ID3DBlob> d3dUtil::CompileShader(
...
wrl::ComPtr<ID3DBlob> d3dUtil::LoadBinary(const std::wstring& filename)
{
